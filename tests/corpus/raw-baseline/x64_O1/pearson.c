...
#define _pearson_tab__r2sleigh_addr 0x100000f70ULL
    ...
    /* r2dec proof: no individual construct is marked; 48 source obligations: 32 rendered, 16 elided, 0 refused; 21 statements rendered; 1 data object type refused */
    {
        uint64_t RCX_6;
        ...
        {
            uint32_t tmp_lane_100000cc6_0_f_1 = (uint32_t)(uint8_t)RCX_6;
            return tmp_lane_100000cc6_0_f_1;
        }
    }
}
