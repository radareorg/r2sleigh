...
{
    /* r2dec proof: no individual construct is marked; 143 source obligations: 118 rendered, 25 elided, 0 refused; 33 statements rendered */
    {
        uint64_t RDX_0_2;
        ...
        }
        {
            ...
            {
                uint32_t tmp_lane_1000008a9_2_37_1 = (uint32_t)RSI_0 ^ (uint32_t)RDX_0_2;
