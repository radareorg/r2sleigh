...
{
    /* r2dec proof: no individual construct is marked; 143 source obligations: 119 rendered, 24 elided, 0 refused; 67 statements rendered */
    {
        uint64_t RDX_0_2;
        ...
        if (!CF_1) {
            ...
            for (; ; ) {
                ...
                uint32_t tmp_lane_100000830_4d_10_1 = (uint32_t)(R8_6 * 4 + R8_6) - 0x19ab949c;
            ...
            case 1:
                {
                    ...
                    int32_t tmp_lane_100000892_7_29_1 = (int32_t)((uint32_t)tmp_11e00_5 ^ (uint32_t)RCX_9);
