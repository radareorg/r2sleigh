...
{
    /* r2dec proof: no individual construct is marked; 143 source obligations: 118 rendered, 25 elided, 0 refused; 37 statements rendered */
    {
        uint64_t RDX_0_2;
            ...
            case 3:
                {
                    ...
                    RCX_7 = (uint64_t)(uint32_t)((uint32_t)tmp_11e00_1 << 16);
                }
            case 2:
                {
                    uint8_t tmp_11e00_3 = ((uint8_t*)RDI_0)[RAX_5 + 1];
                    RCX_9 = (uint64_t)(uint32_t)((uint32_t)tmp_11e00_3 << 8 | (uint32_t)RCX_7);
                }
            case 1:
                {
                    uint8_t tmp_11e00_5 = ((uint8_t*)RDI_0)[RAX_5];
                    uint32_t tmp_lane_100000892_12_2c_1 = (uint32_t)((uint64_t)(int32_t)((uint32_t)tmp_11e00_5 ^ (uint32_t)RCX_9) * 0xffffffffcc9e2d51U);
                    RDX_5 = (uint64_t)(uint32_t)((uint32_t)RDX_0_2 ^ (uint32_t)((uint64_t)(int32_t)(tmp_lane_100000892_12_2c_1 << 15 | tmp_lane_100000892_12_2c_1 >> 17) * 0x1b873593));
                    break;
                }
            case 0:
            default:
