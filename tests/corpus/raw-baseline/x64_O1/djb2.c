    ...
    /* r2dec proof: no individual construct is marked; 41 source obligations: 26 rendered, 15 elided, 0 refused; 20 statements rendered */
    {
        ...
        if (tmp_70500_1 != 0) {
            ...
            for (; ; ) {
                ...
                uint32_t tmp_lane_1000005e0_2a_a_1 = (uint32_t)RAX_1 + tmp_lane_1000005e0_4_6_1;
                uint8_t tmp_11e00_2 = ((uint8_t*)RDI_0)[RCX_1];
                uint32_t tmp_lane_1000005e0_39_f_1 = (uint32_t)tmp_11e00_2 + tmp_lane_1000005e0_2a_a_1;
                RAX_1 = (uint64_t)(uint32_t)tmp_lane_1000005e0_39_f_1;
                RCX_1++;
                uint64_t tmp_3f080_2 = RSI_0;
                uint8_t ZF_8 = tmp_3f080_2 == RCX_1;
                uint8_t tmp_12800_2 = !ZF_8;
                if (!tmp_12800_2) {
                    break;
                }
            }
