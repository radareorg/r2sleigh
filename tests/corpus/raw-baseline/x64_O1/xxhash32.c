uint32_t sym__xxhash32(uint64_t RDI_0, uint64_t RSI_0, uint64_t RDX_0)
{
    /* r2dec proof: no individual construct is marked; 257 source obligations: 209 rendered, 48 elided, 0 refused; 64 statements rendered */
    {
        ...
        if (RSI_0 < 16) {
            ...
            RCX_6 = (uint64_t)(uint32_t)((tmp_lane_100000910_c1_26_1 << 18 | tmp_lane_100000910_c1_26_1 >> 14) + (((uint32_t)tmp_lane_100000910_54_12_1 << 1 | (uint32_t)(tmp_lane_100000910_54_12_1 < 0)) + (tmp_lane_100000910_91_1c_1 << 7 | tmp_lane_100000910_91_1c_1 >> 25) + (tmp_lane_100000910_b8_24_1 << 12 | tmp_lane_100000910_b8_24_1 >> 20)));
        }
        {
            uint64_t RSI_1;
            uint64_t RCX_10;
