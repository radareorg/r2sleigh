...
{
    /* r2dec proof: no individual construct is marked; 48 source obligations: 29 rendered, 19 elided, 0 refused; 15 statements rendered */
    if (RSI_0 == 0) {
        return 0;
    } else {
        uint64_t RCX_1;
        ...
        for (; ; ) {
            ...
            RAX_1 = (uint64_t)tmp_lane_100000610_10_b_1;
            RCX_1++;
            if (RSI_0 == RCX_1) {
                break;
            }
