uint32_t sym__murmur3_32(uint64_t RDI_0, uint64_t RSI_0, uint32_t EDX_0)
{
    ...
    /* r2dec proof: no individual construct is marked; 198 source obligations: 143 rendered, 55 elided, 0 refused; 36 statements rendered */
    {
        uint64_t stack_m48;
        int32_t stack_m28;
        uint64_t stack_m24;
        ...
        for (stack_m56 = 0; stack_m56 < stack_m48; stack_m56++) {
