...
{
    /* r2dec proof: no individual construct is marked; 92 source obligations: 56 rendered, 36 elided, 0 refused; 16 statements rendered */
    {
        uint64_t stack_m24;
        uint8_t* stack_m16;
        int32_t stack_m28;
        ...
        for (stack_m40 = 0; stack_m24 >= stack_m40 + 8; stack_m40 += 7) {
