...
{
    /* r2dec proof: no individual construct is marked; 115 source obligations: 53 rendered, 62 elided, 0 refused; 21 statements rendered */
    {
        uint64_t stack_m40;
        int32_t stack_m28;
        uint64_t stack_m24;
        ...
        for (; ; ) {
            ...
            if (tmp_3f800_2 < RAX_3) {
                ...
                int32_t stack_m44 = (int32_t)*(uint32_t*)(stack_m40 + (uint64_t)stack_m16 + 1);
