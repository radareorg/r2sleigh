...
#define _pearson_tab__r2sleigh_addr 0x100001040ULL
    ...
    /* r2dec proof: no individual construct is marked; 47 source obligations: 37 rendered, 10 elided, 0 refused; 23 statements rendered; 1 data object type refused */
    {
        uint64_t X8_1;
        uint64_t X1_1;
        X8_1 = 0;
        ...
        if (X1_0 != 0) {
            ...
            for (; ; ) {
                ...
                uint8_t tmp_25600_2 = *(uint8_t*)(((uint64_t)((uint32_t)X10_2 ^ (uint32_t)X8_1) & 255) + X9_2);
