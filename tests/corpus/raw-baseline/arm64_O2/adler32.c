...
{
    /* r2dec proof: no individual construct is marked; 62 source obligations: 50 rendered, 12 elided, 0 refused; 24 statements rendered */
    if (X1_0 == 0) {
        return 1;
    } else {
        uint32_t X8_1;
