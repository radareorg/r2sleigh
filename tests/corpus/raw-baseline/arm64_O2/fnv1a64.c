...
{
    /* r2dec proof: no individual construct is marked; 42 source obligations: 32 rendered, 10 elided, 0 refused; 21 statements rendered */
    {
        uint8_t* X8_1;
        uint64_t X0_7;
        uint64_t X1_1;
        ...
        if (X1_0 != 0) {
            ...
            for (; ; ) {
                ...
                X0_7 = X9_3 * ((uint64_t)tmp_25400_2 ^ X0_7);
