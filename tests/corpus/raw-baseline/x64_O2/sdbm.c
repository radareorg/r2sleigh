    ...
    if (RSI_0 == 0) {
        ...
        if (4 <= RSI_0) {
            ...
            for (; ; ) {
                ...
                RAX_1 = (uint64_t)((uint32_t)tmp_11e00_5 + (uint32_t)((uint64_t)(int32_t)((uint32_t)tmp_11e00_4 + (uint32_t)((uint64_t)(int32_t)((uint32_t)tmp_11e00_3 + (uint32_t)((uint64_t)(int32_t)((uint32_t)tmp_11e00_2 + (uint32_t)((uint64_t)(int32_t)RAX_1 * 0x1003f)) * 0x1003f)) * 0x1003f)) * 0x1003f));
                RDX_1 += 4;
                if (RSI_0 == RDX_1) {
                    break;
                }
        ...
        }
        {
            if (RCX_2 != 0) {
                ...
                for (; ; ) {
                    ...
                    RAX_1 = (uint64_t)((uint32_t)tmp_11e00_8 + (uint32_t)((uint64_t)(int32_t)RAX_1 * 0x1003f));
                    RDX_6++;
                    if (RCX_2 == RDX_6) {
                        break;
                    }
