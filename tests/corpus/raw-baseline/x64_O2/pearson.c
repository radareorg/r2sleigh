...
#define _pearson_tab__r2sleigh_addr 0x100001680ULL
    ...
    /* r2dec proof: no individual construct is marked; 127 source obligations: 101 rendered, 26 elided, 0 refused; 36 statements rendered; 1 data object type refused */
    {
        uint64_t RDX_1;
        if (RSI_0 == 0) {
            RDX_1 = (uint64_t)0;
