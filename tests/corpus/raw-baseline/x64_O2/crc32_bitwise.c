...
{
    /* r2dec proof: no individual construct is marked; 313 source obligations: 294 rendered, 19 elided, 0 refused; 58 statements rendered */
    if (RSI_0 == 0) {
        return 0;
    } else {
        uint64_t RAX_1;
        ...
        for (; ; ) {
            ...
            XMM2_2 = (XMM2_2 & ~((__uint128_t)~(uint32_t)0U << 64U)) | (__uint128_t)tmp_lane_100000a50_7_6_1 << 64;
            XMM2_2 = (XMM2_2 & ~((__uint128_t)~(uint32_t)0U << 96U)) | (__uint128_t)tmp_lane_100000a50_7_6_1 << 96;
            XMM2_2 &= XMM0_1;
            ...
            XMM3_6 = (XMM3_6 & ~((__uint128_t)~(uint32_t)0U << 0U)) | (__uint128_t)tmp_lane_100000a50_1e3_63_1 << 0;
            XMM3_6 = (XMM3_6 & ~((__uint128_t)~(uint32_t)0U << 32U)) | (__uint128_t)tmp_lane_100000a50_1e4_64_1 << 32;
            XMM3_6 = (XMM3_6 & ~((__uint128_t)~(uint32_t)0U << 64U)) | (__uint128_t)tmp_lane_100000a50_1e3_63_1 << 64;
            XMM3_6 = (XMM3_6 & ~((__uint128_t)~(uint32_t)0U << 96U)) | (__uint128_t)tmp_lane_100000a50_1e4_64_1 << 96;
            XMM3_6 ^= XMM2_17;
