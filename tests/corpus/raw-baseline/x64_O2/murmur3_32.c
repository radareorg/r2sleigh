            ...
            case 3:
                {
                    ...
                    RCX_8 = (uint32_t)((uint32_t)tmp_11e00_1 << 16);
                }
            case 2:
                {
                    uint8_t tmp_11e00_3 = ((uint8_t*)RDI_0)[RAX_13 + 1];
                    RCX_8 = (uint32_t)((uint32_t)tmp_11e00_3 << 8 | (uint32_t)RCX_8);
                }
            case 1:
                {
                    ...
                    RDX_0_2 = (uint32_t)((uint32_t)RDX_0_2 ^ (uint32_t)((uint64_t)(int32_t)(tmp_lane_100000dbd_12_4e_1 << 15 | tmp_lane_100000dbd_12_4e_1 >> 17) * 0x1b873593));
                    break;
                }
            case 0:
            default:
