...
{
    /* r2dec proof: no individual construct is marked; 220 source obligations: 190 rendered, 30 elided, 0 refused; 105 statements rendered */
    {
        uint64_t RDX_0_2;
        uint64_t RDX_8;
        ...
        if (!CF_1) {
            ...
            if (tmp_3ea80_2 != 1) {
                ...
                for (; ; ) {
                    ...
                    uint32_t tmp_lane_100000d10_49_11_1 = (uint32_t)(R8_6 * 4 + R8_6);
                    uint32_t tmp_lane_100000d10_4d_13_1 = tmp_lane_100000d10_49_11_1 - 0x19ab949c;
                    ...
                    uint32_t tmp_lane_100000d10_9f_20_1 = (uint32_t)(R8_11 * 4 + R8_11);
                    uint32_t tmp_lane_100000d10_a3_22_1 = tmp_lane_100000d10_9f_20_1 - 0x19ab949c;
                    RDX_0_2 = (uint64_t)(uint32_t)tmp_lane_100000d10_a3_22_1;
                    RAX_2 += 8;
                    RCX_1 -= 2;
                    uint8_t ZF_13 = RCX_1 == 0;
                    RAX_1 = RAX_2;
                    if (ZF_13) {
                        break;
                    }
        ...
        }
        {
            ...
            uint32_t tmp_lane_100000d87_a_34_1 = (uint32_t)RSI_0;
            uint32_t tmp_lane_100000d87_e_37_1 = tmp_lane_100000d87_a_34_1 & 3;
            RCX_10 = 0;
            RCX_12 = 0;
            RDX_10 = RDX_8;
            ...
            case 1:
                {
                    ...
                    uint32_t tmp_lane_100000dbd_3_48_1 = (uint32_t)tmp_11e00_5;
                    int32_t tmp_lane_100000dbd_7_4b_1 = (int32_t)((uint32_t)RCX_12 ^ tmp_lane_100000dbd_3_48_1);
