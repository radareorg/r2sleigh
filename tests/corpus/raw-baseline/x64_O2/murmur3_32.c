...
{
    /* r2dec proof: no individual construct is marked; 220 source obligations: 189 rendered, 31 elided, 0 refused; 59 statements rendered */
    {
        uint64_t RDX_0_2;
        uint64_t RDX_8;
        RDX_0_2 = (uint64_t)(uint32_t)EDX_0;
        uint8_t CF_1 = RSI_0 < 4;
        RDX_8 = RDX_0_2;
        if (!CF_1) {
            uint64_t RCX_2;
            uint64_t RAX_1;
            ...
            if (RCX_2 != 1) {
                ...
                for (; ; ) {
                    ...
                    uint64_t R8_11 = (uint64_t)(uint32_t)(tmp_lane_100000d10_81_1c_1 << 13 | tmp_lane_100000d10_81_1c_1 >> 19);
                    RDX_0_2 = (uint64_t)(uint32_t)((uint32_t)(R8_11 * 4 + R8_11) - 0x19ab949c);
                    RAX_2 += 8;
                    RCX_2 -= 2;
                    uint8_t tmp_12800_3 = RCX_2 != 0;
                    RAX_1 = RAX_2;
                    if (!tmp_12800_3) {
                        break;
                    }
            ...
            {
                uint8_t ZF_15 = (uint8_t)((uint8_t)RSI_0 & 4) == 0;
                RDX_8 = RDX_0_2;
                if (!ZF_15) {
                    ...
                    RDX_8 = (uint64_t)(uint32_t)((uint32_t)(RAX_10 * 4 + RAX_10) - 0x19ab949c);
                }
            }
        }
        {
            ...
            case 3:
                {
                    ...
                    RCX_10 = (uint64_t)(uint32_t)((uint32_t)tmp_11e00_1 << 16);
                }
            case 2:
                {
                    uint8_t tmp_11e00_3 = ((uint8_t*)RDI_0)[RAX_13 + 1];
                    RCX_12 = (uint64_t)(uint32_t)((uint32_t)tmp_11e00_3 << 8 | (uint32_t)RCX_10);
                }
            case 1:
                {
                    uint8_t tmp_11e00_5 = ((uint8_t*)RDI_0)[RAX_13];
                    uint32_t tmp_lane_100000dbd_12_4e_1 = (uint32_t)((uint64_t)(int32_t)((uint32_t)tmp_11e00_5 ^ (uint32_t)RCX_12) * 0xffffffffcc9e2d51U);
                    RDX_10 = (uint64_t)(uint32_t)((uint32_t)RDX_8 ^ (uint32_t)((uint64_t)(int32_t)(tmp_lane_100000dbd_12_4e_1 << 15 | tmp_lane_100000dbd_12_4e_1 >> 17) * 0x1b873593));
                    break;
                }
            case 0:
            default:
