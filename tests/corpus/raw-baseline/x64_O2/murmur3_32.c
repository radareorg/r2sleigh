    ...
    /* r2dec proof: no individual construct is marked; 215 source obligations: 185 rendered, 30 elided, 0 refused; 48 statements rendered */
    {
        ...
        if (RSI_0 >= 4) {
            ...
            if ((uint8_t)((uint8_t)RSI_0 & 4) != 0) {
                ...
                RDX_0_2 = (uint64_t)(uint32_t)((uint32_t)(RAX_10 * 4 + RAX_10) - 0x19ab949c);
            }
        }
        {
            uint64_t RCX_8;
            ...
            case 3:
                {
                    ...
                    RCX_8 = (uint64_t)(uint32_t)((uint32_t)tmp_11e00_1 << 16);
                }
            case 2:
                {
                    uint8_t tmp_11e00_3 = ((uint8_t*)RDI_0)[RAX_13 + 1];
                    RCX_8 = (uint64_t)(uint32_t)((uint32_t)tmp_11e00_3 << 8 | (uint32_t)RCX_8);
                }
            case 1:
                {
                    uint8_t tmp_11e00_5 = ((uint8_t*)RDI_0)[RAX_13];
                    uint32_t tmp_lane_100000dbd_12_4e_1 = (uint32_t)((uint64_t)(int32_t)((uint32_t)tmp_11e00_5 ^ (uint32_t)RCX_8) * 0xffffffffcc9e2d51U);
                    RDX_0_2 = (uint64_t)(uint32_t)((uint32_t)RDX_0_2 ^ (uint32_t)((uint64_t)(int32_t)(tmp_lane_100000dbd_12_4e_1 << 15 | tmp_lane_100000dbd_12_4e_1 >> 17) * 0x1b873593));
                    break;
                }
            case 0:
            default:
            ...
            {
                uint32_t tmp_lane_100000dd4_2_59_1 = (uint32_t)RSI_0 ^ (uint32_t)RDX_0_2;
