    ...
    if (RSI_0 == 0) {
        ...
        if (4 <= RSI_0) {
            ...
            for (; ; ) {
                ...
                RAX_2 = (uint64_t)(uint32_t)((uint64_t)(int32_t)((uint32_t)tmp_11e00_5 ^ (uint32_t)((uint64_t)(int32_t)((uint32_t)tmp_11e00_4 ^ (uint32_t)((uint64_t)(int32_t)((uint32_t)((uint64_t)(int32_t)((uint32_t)tmp_11e00_2 ^ (uint32_t)RAX_2) * 0x1000193) ^ (uint32_t)tmp_11e00_3) * 0x1000193)) * 0x1000193)) * 0x1000193);
                RDX_2 += 4;
