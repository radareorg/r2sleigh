...
{
    /* r2dec proof: no individual construct is marked; 124 source obligations: 94 rendered, 30 elided, 0 refused; 40 statements rendered */
    if (RSI_0 == 0) {
        return 0x1505;
    } else {
        uint64_t RAX_1;
        ...
        if (4 <= RSI_0) {
            ...
            for (; ; ) {
                ...
                uint32_t tmp_lane_1000006f0_39_17_1 = (uint32_t)tmp_11e00_2 + ((uint32_t)RAX_2 * 32 + (uint32_t)RAX_2);
                ...
                RAX_2 = (uint64_t)(uint32_t)((uint32_t)tmp_11e00_5 + tmp_lane_1000006f0_b9_2f_1 + tmp_lane_1000006f0_b9_2f_1 * 32);
                RDX_2 += 4;
