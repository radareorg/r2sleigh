...
{
    /* r2dec proof: no individual construct is marked; 164 source obligations: 136 rendered, 28 elided, 0 refused; 46 statements rendered */
    if (RSI_0 == 0) {
        return 1;
    } else {
        uint64_t RCX_1;
        ...
        if (RSI_0 != 1) {
            ...
            for (; ; ) {
                ...
                RAX_2 = (uint64_t)(uint32_t)(tmp_lane_100000850_ee_2e_1 - (uint32_t)((uint64_t)(int32_t)((uint64_t)tmp_lane_100000850_ee_2e_1 * 0x2001f >> 33) * 0xfff1));
                RDX_2 += 2;
                uint8_t tmp_12800_3 = R8_2 != RDX_2;
                RAX_1 = RAX_2;
                RCX_1 = RCX_2;
                RDX_1 = RDX_2;
                if (!tmp_12800_3) {
        ...
        }
        {
            ...
            if ((uint8_t)((uint8_t)RSI_0 & 1) != 0) {
                ...
                RAX_10 = (uint64_t)(uint32_t)(tmp_lane_1000008c5_53_44_1 - (uint32_t)((uint64_t)(int32_t)((uint64_t)tmp_lane_1000008c5_53_44_1 * 0x80078071 >> 47) * 0xfff1));
            }
            return (uint64_t)((uint32_t)RAX_10 << 16 | (uint32_t)RCX_17);
        }
    }
}
