...
{
    /* r2dec proof: no individual construct is marked; 164 source obligations: 136 rendered, 28 elided, 0 refused; 36 statements rendered */
    if (RSI_0 == 0) {
        return 1;
    } else {
        uint64_t RCX_1;
        ...
        if (RSI_0 != 1) {
            ...
            for (; ; ) {
                ...
                RCX_1 = (uint64_t)(uint32_t)tmp_lane_100000850_e4_2a_1;
                ...
                RDX_1 += 2;
                uint8_t tmp_12800_3 = R8_2 != RDX_1;
                if (!tmp_12800_3) {
                    break;
                }
            }
        ...
        }
        {
            if ((uint8_t)((uint8_t)RSI_0 & 1) != 0) {
                ...
                RCX_1 = (uint64_t)(uint32_t)tmp_lane_1000008c5_49_40_1;
                uint32_t tmp_lane_1000008c5_53_44_1 = (uint32_t)RAX_1 + tmp_lane_1000008c5_49_40_1;
                RAX_1 = (uint64_t)(uint32_t)(tmp_lane_1000008c5_53_44_1 - (uint32_t)((uint64_t)(int32_t)((uint64_t)tmp_lane_1000008c5_53_44_1 * 0x80078071 >> 47) * 0xfff1));
            }
