...
{
    /* r2dec proof: no individual construct is marked; 376 source obligations: 314 rendered, 62 elided, 0 refused; 183 statements rendered */
    {
        uint64_t RCX_6;
        ...
        }
        {
            ...
            uint64_t RCX_10;
            uint64_t RDI_4;
            uint32_t tmp_lane_100000ebd_2_42_1 = (uint32_t)RSI_0 + (uint32_t)RCX_6;
            ...
            }
            {
                ...
                if (!tmp_12700_1) {
                    uint64_t RDI_11;
                    uint32_t tmp_lane_100000efd_4_51_1 = (uint32_t)RAX_1 - (uint32_t)RCX_10;
                    ...
                    if (tmp_lane_100000efd_e_54_1 != 0) {
                        for (; ; ) {
                            ...
                            uint64_t tmp_4c780_16 = (uint64_t)(int32_t)tmp_11e00_2 * 0x165667b1;
                    ...
                    }
                    {
                        ...
                        uint8_t tmp_12a80_1 = !(CF_49 || ZF_29);
                        RSI_22 = RSI_1;
                        if (!tmp_12a80_1) {
                            for (; ; ) {
                                uint8_t tmp_11e00_5 = *(uint8_t*)RCX_10;
                                uint64_t tmp_4c780_20 = (uint64_t)(int32_t)tmp_11e00_5 * 0x165667b1;
                                ...
                                uint64_t tmp_4c780_22 = (uint64_t)(int32_t)tmp_11e00_6 * 0x165667b1;
                                ...
                                uint64_t tmp_4c780_24 = (uint64_t)(int32_t)tmp_11e00_7 * 0x165667b1;
                                ...
                                uint64_t tmp_4c780_26 = (uint64_t)(int32_t)tmp_11e00_8 * 0x165667b1;
