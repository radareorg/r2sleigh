...
{
    /* r2dec proof: no individual construct is marked; 362 source obligations: 301 rendered, 61 elided, 0 refused; 81 statements rendered */
    {
        uint32_t RCX_6;
        ...
        if (RSI_0 < 16) {
            ...
            for (; ; ) {
                ...
                uint32_t tmp_lane_100000e40_c_6_1 = (uint32_t)((uint64_t)tmp_11f00_2 * 0xffffffff85ebca77U) + R10_1;
                int32_t tmp_11f00_3 = (int32_t)((uint32_t*)RDI_0)[1];
                uint32_t tmp_lane_100000e40_35_d_1 = (uint32_t)((uint64_t)tmp_11f00_3 * 0xffffffff85ebca77U) + R9_1;
                ...
                R9_1 = tmp_lane_100000e40_91_1c_1;
                uint32_t tmp_lane_100000e40_99_1f_1 = (uint32_t)((uint64_t)tmp_11f00_5 * 0xffffffff85ebca77U) + RCX_1;
                ...
                RDX_0 = (uint64_t)tmp_lane_100000e40_b8_24_1;
                ...
                RCX_1 = tmp_lane_100000e40_c1_26_1;
                RDI_0 += 16;
                if (R8_1 < RDI_0) {
                    break;
                }
        ...
        }
        {
            ...
            if (RDI_0 + 4 <= tmp_4a00_1) {
                for (; ; ) {
                    ...
                    uint32_t tmp_lane_100000ed0_c_47_1 = (uint32_t)((uint64_t)tmp_11f00_8 * 0xffffffffc2b2ae3dU) + RSI_1;
            ...
            }
            {
                ...
                if (RCX_10 < tmp_4a00_1) {
                    ...
                    RDI_10 = (uint64_t)tmp_lane_100000efd_e_54_1;
                ...
                {
                    uint32_t tmp_lane_100000f9c_35_97_1 = (uint32_t)((uint64_t)(int32_t)(RSI_1 >> 15 ^ RSI_1) * 0xffffffff85ebca77U);
