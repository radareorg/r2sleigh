...
{
    /* r2dec proof: no individual construct is marked; 376 source obligations: 314 rendered, 62 elided, 0 refused; 112 statements rendered */
    {
        uint64_t RCX_6;
        uint64_t RAX_1 = RSI_0 + RDI_0;
        uint8_t CF_1 = RSI_0 < 16;
        if (CF_1) {
            ...
            for (; ; ) {
                ...
                tmp_lane_100000e40_54_12_1 = (int32_t)((uint64_t)tmp_lane_100000e40_18_9_1 * 0xffffffff9e3779b1U);
                ...
                int32_t tmp_lane_100000e40_88_1a_1 = (int32_t)((uint64_t)tmp_11f00_5 * 0xffffffff85ebca77U);
                tmp_lane_100000e40_91_1c_1 = (uint32_t)((uint64_t)tmp_lane_100000e40_41_10_1 * 0xffffffff9e3779b1U);
                R9_1 = (uint64_t)(uint32_t)tmp_lane_100000e40_91_1c_1;
                uint32_t tmp_lane_100000e40_99_1f_1 = (uint32_t)RCX_1 + (uint32_t)tmp_lane_100000e40_88_1a_1;
                tmp_lane_100000e40_b8_24_1 = (uint32_t)((uint64_t)tmp_lane_100000e40_73_19_1 * 0xffffffff9e3779b1U);
            ...
            }
            {
                ...
                RCX_6 = (uint64_t)(uint32_t)((tmp_lane_100000e40_c1_26_1 << 18 | tmp_lane_100000e40_c1_26_1 >> 14) + (((uint32_t)tmp_lane_100000e40_54_12_1 << 1 | (uint32_t)(tmp_lane_100000e40_54_12_1 < 0)) + tmp_lane_100000e9e_29_30_1 + (tmp_lane_100000e40_91_1c_1 << 7 | tmp_lane_100000e40_91_1c_1 >> 25)));
            }
        }
        {
            uint64_t RSI_1;
                    ...
                    }
                    {
                        ...
                        if (!tmp_12a80_1) {
                            for (; ; ) {
                                ...
                                int32_t tmp_lane_100000f40_2d_6b_1 = (int32_t)((uint64_t)(int32_t)(tmp_lane_100000f40_e_66_1 << 11 | tmp_lane_100000f40_e_66_1 >> 21) * 0xffffffff9e3779b1U);
                                uint8_t tmp_11e00_6 = ((uint8_t*)RCX_10)[1];
                                uint32_t tmp_lane_100000f40_42_71_1 = (uint32_t)((uint64_t)(int32_t)tmp_11e00_6 * 0x165667b1) + (uint32_t)tmp_lane_100000f40_2d_6b_1;
                                int32_t tmp_lane_100000f40_61_76_1 = (int32_t)((uint64_t)(int32_t)(tmp_lane_100000f40_42_71_1 << 11 | tmp_lane_100000f40_42_71_1 >> 21) * 0xffffffff9e3779b1U);
                                uint8_t tmp_11e00_7 = ((uint8_t*)RCX_10)[2];
                                uint32_t tmp_lane_100000f40_76_7c_1 = (uint32_t)((uint64_t)(int32_t)tmp_11e00_7 * 0x165667b1) + (uint32_t)tmp_lane_100000f40_61_76_1;
                                int32_t tmp_lane_100000f40_95_81_1 = (int32_t)((uint64_t)(int32_t)(tmp_lane_100000f40_76_7c_1 << 11 | tmp_lane_100000f40_76_7c_1 >> 21) * 0xffffffff9e3779b1U);
                                uint8_t tmp_11e00_8 = ((uint8_t*)RCX_10)[3];
                                uint32_t tmp_lane_100000f40_aa_87_1 = (uint32_t)((uint64_t)(int32_t)tmp_11e00_8 * 0x165667b1) + (uint32_t)tmp_lane_100000f40_95_81_1;
