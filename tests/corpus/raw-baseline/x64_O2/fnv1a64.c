...
{
    /* r2dec proof: no individual construct is marked; 116 source obligations: 83 rendered, 33 elided, 0 refused; 33 statements rendered */
    {
        int64_t R8_1;
        ...
        if (RSI_0 == 0) {
            ...
            if (4 <= RSI_0) {
                ...
                for (; ; ) {
                    ...
                    R9_1 += 4;
                    uint8_t tmp_12800_2 = RSI_0 != R9_1;
                    if (!tmp_12800_2) {
                        break;
                    }
                }
