...
{
    /* r2dec proof: no individual construct is marked; 116 source obligations: 84 rendered, 32 elided, 0 refused; 58 statements rendered */
    {
        int64_t R8_1;
        ...
        if (tmp_70500_1 == 0) {
            ...
            uint64_t R9_1;
            uint32_t tmp_lane_100000623_1_0_1 = (uint32_t)RSI_0;
            uint32_t tmp_lane_100000623_5_3_1 = tmp_lane_100000623_1_0_1 & 3;
            ...
            if (4 <= tmp_3ea80_1) {
                ...
                for (; ; ) {
                    ...
                    uint8_t ZF_13 = tmp_3f080_2 == R9_2;
                    R9_1 = R9_2;
                    if (ZF_13) {
                        break;
                    }
            ...
            }
            {
                ...
                if (!ZF_15) {
                    ...
                    for (; ; ) {
                        ...
                        uint8_t ZF_21 = tmp_3f080_5 == RSI_3;
                        RAX_14 = R8_1;
                        if (ZF_21) {
                            break;
                        }
