...
#define _pearson_tab__r2sleigh_addr 0x100001f68ULL
    ...
    /* r2dec proof: no individual construct is marked; 84 source obligations: 49 rendered, 35 elided, 0 refused; 26 statements rendered; 1 data object type refused */
    {
        uint64_t stack_m32;
        uint8_t stack_m17;
        uint64_t stack_m16;
        ...
        for (; ; ) {
            ...
            if (CY_2) {
                ...
                uint64_t X8_6 = tmp_11f80_2;
                uint64_t tmp_11700_2 = (uint64_t)tmp_20380_2;
                uint8_t* tmp_11800_2 = (uint8_t*)(X8_6 + tmp_11700_2);
                uint8_t tmp_25500_3 = *tmp_11800_2;
                stack_m17 = tmp_25500_3;
                {
                    uint64_t tmp_11f80_3 = stack_m32 + 1;
                    uint64_t X8_10 = tmp_11f80_3;
                    stack_m32 = X8_10;
                }
            }
        }
