...
{
    /* r2dec proof: no individual construct is marked; 108 source obligations: 70 rendered, 38 elided, 0 refused; 26 statements rendered */
    {
        uint64_t stack_m16;
        uint8_t* stack_m8;
        uint32_t stack_m20;
        ...
        {
            for (; ; ) {
                uint8_t TMPCY_7 = stack_m16 <= stack_m32;
                if (TMPCY_7) {
                    break;
                } else {
