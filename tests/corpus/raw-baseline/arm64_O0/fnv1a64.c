...
{
    /* r2dec proof: no individual construct is marked; 78 source obligations: 39 rendered, 39 elided, 0 refused; 20 statements rendered */
    {
        uint64_t stack_m32;
        uint64_t stack_m24;
        uint64_t stack_m16;
        ...
        for (; ; ) {
            ...
            if (TMPCY_2) {
                ...
                stack_m24 = stack_m24 * 0x100000001b3;
                {
