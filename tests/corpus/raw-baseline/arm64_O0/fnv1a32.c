...
{
    /* r2dec proof: no individual construct is marked; 53 source obligations: 32 rendered, 21 elided, 0 refused; 12 statements rendered */
    {
        uint64_t stack_m16;
        uint8_t* stack_m8;
        uint32_t stack_m20;
        ...
        for (stack_m32 = 0; stack_m32 < stack_m16; stack_m32++) {
            ...
            stack_m20 = ((uint32_t)tmp_25600_2 ^ stack_m20) * 0x1000193;
        }
        {
            return stack_m20;
        }
