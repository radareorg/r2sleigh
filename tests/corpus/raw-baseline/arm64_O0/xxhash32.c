uint32_t sym__xxhash32(uint64_t X0_0, uint64_t X1_0, uint32_t W2_0)
{
    ...
    /* r2dec proof: no individual construct is marked; 502 source obligations: 393 rendered, 109 elided, 0 refused; 109 statements rendered */
    {
        uint32_t stack_m52;
        uint64_t stack_m48;
        uint32_t stack_m36;
        ...
        X9_1 = stack_m32;
        {
            ...
            if (X9_1 < 16) {
                ...
                tmp_24d00_1 = stack_m36;
                stack_m68 = tmp_24c00_1 + (stack_m96 + tmp_24d00_1);
                tmp_24d00_1 = stack_m36;
                ...
                for (; ; ) {
                    ...
                    uint64_t X0_5 = (uint64_t)sym__rotl32((uint32_t)(stack_m72 + stack_m92 * tmp_24c00_11), 13);
                    stack_m72 = stack_m96 * (uint32_t)X0_5;
                    X8_5 = stack_m24;
                    stack_m24 = X8_5 + 4;
                    X8_5 = stack_m24;
                    uint32_t tmp_24c00_17 = *(uint32_t*)X8_5;
                    uint64_t X0_7 = (uint64_t)sym__rotl32((uint32_t)(tmp_24d00_1 + stack_m92 * tmp_24c00_17), 13);
                    tmp_24d00_1 = stack_m96 * (uint32_t)X0_7;
                    X8_5 = stack_m24;
                    stack_m24 = X8_5 + 4;
                    X8_5 = stack_m24;
                    uint32_t tmp_24c00_23 = *(uint32_t*)X8_5;
                    uint64_t X0_9 = (uint64_t)sym__rotl32((uint32_t)(stack_m80 + stack_m92 * tmp_24c00_23), 13);
