uint32_t sym__xxhash32(uint64_t X0_0, uint64_t X1_0, uint32_t W2_0)
{
    ...
    /* r2dec proof: no individual construct is marked; 373 source obligations: 294 rendered, 79 elided, 0 refused; 87 statements rendered */
    {
        uint32_t stack_m36;
        uint64_t stack_m32;
        uint64_t stack_m24;
