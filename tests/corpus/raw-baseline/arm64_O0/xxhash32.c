uint32_t sym__xxhash32(uint64_t X0_0, uint64_t X1_0, uint32_t W2_0)
{
    ...
    /* r2dec proof: no individual construct is marked; 434 source obligations: 331 rendered, 103 elided, 0 refused; 108 statements rendered */
    {
        uint32_t stack_m52;
        uint64_t stack_m48;
        uint32_t stack_m36;
        ...
        X9_1 = stack_m32;
        if (X9_1 < 16) {
            uint32_t tmp_24d00_5 = stack_m36;
            stack_m52 = tmp_24d00_5 + 0x165667b1;
        } else {
            uint32_t stack_m68;
            uint32_t stack_m72;
            uint32_t stack_m76;
            ...
            uint32_t tmp_24d00_2 = stack_m36;
            stack_m72 = tmp_24d00_2 + tmp_2a000_4;
            uint32_t tmp_24d00_3 = stack_m36;
            stack_m76 = tmp_24d00_3;
            uint32_t tmp_24d00_4 = stack_m36;
            stack_m80 = tmp_24d00_4 + 0x61c8864f;
            for (; ; ) {
                X8_5 = stack_m24;
                ...
                uint64_t X0_7 = (uint64_t)sym__rotl32((uint32_t)(tmp_24c00_17 * tmp_2a000_4 + stack_m76), 13);
                stack_m76 = (uint32_t)X0_7 * tmp_2a000_2;
                X8_5 = stack_m24;
                stack_m24 = X8_5 + 4;
                X8_5 = stack_m24;
        ...
        }
        {
            ...
            }
            {
                ...
                }
                {
                    ...
                    stack_m52 = tmp_24d00_14 * tmp_2a000_4;
