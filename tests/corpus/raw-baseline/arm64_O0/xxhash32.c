uint32_t sym__xxhash32(uint64_t X0_0, uint64_t X1_0, uint32_t W2_0)
{
    ...
    /* r2dec proof: no individual construct is marked; 502 source obligations: 393 rendered, 109 elided, 0 refused; 123 statements rendered */
    {
        uint32_t stack_m52;
        uint64_t stack_m48;
        uint32_t stack_m36;
        ...
        uint8_t tmp_b00_1 = !TMPCY_3;
        {
            ...
            if (tmp_b00_1) {
                ...
                tmp_24d00_1 = stack_m36;
                uint32_t tmp_12280_1 = stack_m96 + tmp_24d00_1;
                ...
                for (; ; ) {
                    ...
                    uint64_t X0_3 = (uint64_t)sym__rotl32((uint32_t)(stack_m68 + stack_m92 * tmp_24c00_5), 13);
                    ...
                    uint64_t X0_5 = (uint64_t)sym__rotl32((uint32_t)(stack_m72 + stack_m92 * tmp_24c00_11), (uint8_t)X1_4);
                    ...
                    uint64_t X0_7 = (uint64_t)sym__rotl32((uint32_t)(tmp_24d00_1 + stack_m92 * tmp_24c00_17), (uint8_t)X1_6);
                    ...
                    uint64_t X0_9 = (uint64_t)sym__rotl32((uint32_t)(stack_m80 + stack_m92 * tmp_24c00_23), (uint8_t)X1_8);
                    ...
                    stack_m24 = X8_5 + 4;
                    {
                        ...
                        uint8_t tmp_1000_2 = TMPZR_18 || !TMPCY_18;
                        if (!tmp_1000_2) {
                            break;
                        }
                    }
                }
                {
                    ...
                    stack_m52 = (uint32_t)X0_11 + (uint32_t)X8_56 + (uint32_t)X0_16 + (uint32_t)X0_18;
                }
            }
        }
        {
            ...
            stack_m52 = (uint32_t)X9_26 + tmp_24d00_7;
            for (; ; ) {
                X8_5 = stack_m24;
            ...
            }
            {
                for (; ; ) {
                    X8_5 = stack_m24;
                    uint8_t TMPCY_31 = stack_m48 <= X8_5;
                    if (TMPCY_31) {
                        break;
                    } else {
