...
{
    /* r2dec proof: no individual construct is marked; 67 source obligations: 43 rendered, 24 elided, 0 refused; 19 statements rendered */
    {
        uint64_t stack_m16;
        uint8_t* stack_m8;
        uint32_t stack_m20;
        ...
        for (stack_m32 = 0; stack_m32 < stack_m16; stack_m32++) {
            ...
            stack_m20 = tmp_12280_2 - tmp_42288_2 * 0xfff1;
            uint32_t tmp_12280_3 = stack_m20 + stack_m24;
            uint32_t tmp_42288_3 = tmp_12280_3 / 0xfff1;
            stack_m24 = tmp_12280_3 - tmp_42288_3 * 0xfff1;
        }
        {
