...
{
    /* r2dec proof: no individual construct is marked; 260 source obligations: 222 rendered, 38 elided, 0 refused; 93 statements rendered */
    {
        uint64_t X2_0_2;
        uint64_t X14_8;
        uint64_t X12_8;
        ...
        }
        {
            ...
            if (X15_9 <= X11_1) {
                ...
                for (; ; ) {
                    ...
                    uint8_t ZR_7 = X12_10 == X11_1;
                    uint8_t CY_7 = X11_1 <= X12_10;
