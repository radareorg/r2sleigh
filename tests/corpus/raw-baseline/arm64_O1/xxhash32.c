uint32_t sym__xxhash32(uint64_t X0_0, uint64_t X1_0, uint32_t W2_0)
{
    /* r2dec proof: no individual construct is marked; 245 source obligations: 207 rendered, 38 elided, 0 refused; 83 statements rendered */
    {
        ...
        if (X1_0 < 16) {
            X14_8 = (uint32_t)(tmp_2a000_6 + W2_0);
            X12_5 = X0_0;
        } else {
            uint32_t X15_1;
            uint32_t X16_1;
            ...
            X16_1 = (uint32_t)(W2_0 + tmp_2a000_4);
        ...
        }
        {
            ...
            if (X15_9 <= X11_1) {
                ...
                for (; ; ) {
                    ...
                    X14_11 = (uint32_t)((tmp_28e80_8 >> 15 | tmp_28e80_8 << 17) * tmp_2a000_15);
            ...
            }
            {
                if (X15_10 < X11_1) {
                    ...
                    for (; ; ) {
                        ...
                        X14_11 = (uint32_t)((tmp_28e80_11 >> 21 | tmp_28e80_11 << 11) * tmp_2a000_2);
