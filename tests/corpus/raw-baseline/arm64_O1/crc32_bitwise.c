...
{
    /* r2dec proof: no individual construct is marked; 66 source obligations: 52 rendered, 14 elided, 0 refused; 26 statements rendered */
    if (X1_0 == 0) {
        return 0;
    } else {
        uint64_t X9_1;
        ...
        for (; ; ) {
            ...
            X11_5 = 8;
            for (; ; ) {
                tmp_20380_4 = (((uint32_t)X8_1 & 1) * 0xffffffff & tmp_2a000_2) ^ (uint32_t)X8_1 >> 1;
                X8_1 = (uint64_t)(uint32_t)tmp_20380_4;
                uint32_t tmp_lane_1000006d0_a_8_1 = (uint32_t)X11_5;
                X11_5 = (uint64_t)(uint32_t)(tmp_lane_1000006d0_a_8_1 - 1);
