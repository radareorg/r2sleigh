...
{
    /* r2dec proof: no individual construct is marked; 66 source obligations: 51 rendered, 15 elided, 0 refused; 33 statements rendered */
    if (X1_0 == 0) {
        uint64_t X0_2 = 0;
        return X0_2;
    } else {
        ...
        for (; ; ) {
            ...
            X11_5 = 8;
            for (; ; ) {
                uint32_t tmp_35880_3 = ((uint32_t)X8_1 & 1) * 0xffffffff;
                uint32_t tmp_12880_3 = tmp_35880_3 & tmp_2a000_2;
                ...
                uint8_t TMPZR_3 = tmp_lane_1000006d0_a_8_1 == 1;
                X11_5 = (uint64_t)(uint32_t)tmp_3de80_3;
                uint8_t ZR_3 = TMPZR_3;
                if (ZR_3) {
                    break;
                }
            }
