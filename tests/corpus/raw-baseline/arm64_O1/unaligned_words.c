...
{
    /* r2dec proof: no individual construct is marked; 92 source obligations: 73 rendered, 19 elided, 0 refused; 33 statements rendered */
    {
        uint64_t X0_2;
        uint64_t X11_1;
        ...
        if (8 <= X1_0) {
            ...
            for (; ; ) {
                ...
                X0_2 = (uint64_t)(tmp_2a000_4 * ((uint32_t)X0_2 ^ tmp_25180_2));
                X11_1 = X12_1 + 7;
